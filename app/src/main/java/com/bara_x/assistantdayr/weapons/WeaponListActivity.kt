...
//                ).show()
                ...
                if (position == 0) {
                    val intent =
                        Intent(this@WeaponListActivity, CartDescription::class.java)
                    startActivity(intent)

                }
                if (position == 1) {
                    val intent =
                        Intent(this@WeaponListActivity,  BicycleDescription::class.java)
                    startActivity(intent)

                }
                if (position == 2) {
                    val intent =
                        Intent(this@WeaponListActivity, MotocycleDescription::class.java)
                    startActivity(intent)

                }
                if (position == 3) {
                    val intent =
                        Intent(this@WeaponListActivity, ClassicMobileDescription::class.java)
                    startActivity(intent)

                }
                if (position == 4) {
                    val intent =
                        Intent(this@WeaponListActivity, WeaponListActivity::class.java)
                    startActivity(intent)
